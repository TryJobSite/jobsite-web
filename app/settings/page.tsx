              ...
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <div className="space-y-2">
                  ...
                  {contactForm.formState.errors.phoneNumber && (
                    <p className="text-sm text-red-500">{contactForm.formState.errors.phoneNumber.message}</p>
                  )}
                  <p className="text-xs text-slate-500">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div className="space-y-2">
                  <Label htmlFor="contractorType">
                    Contractor Type {!user.contractorType && <span className="text-red-500">(Missing)</span>}
                  </Label>
                  <select
                    id="contractorType"
