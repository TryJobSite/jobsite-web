  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        border bg-background p-6 shadow-lg duration-200 data-[state=closed]:animate-out
        ...
        data-[state=open]:slide-in-from-top-[48%] data-[state=open]:zoom-in-95 sm:rounded-lg`,
        className
      )}
      {...props}
    >
      ...
      <DialogPrimitive.Close
        className="absolute top-4 right-4 rounded-sm opacity-70 ring-offset-background transition-opacity
