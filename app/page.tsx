...
export default function Home() {
  ...
  console.log({ homeMe: me });
  // if (me?.user?.userId) return router.replace('/home');
  return (
    <>
      <LoggedOutHeader />
          ...
          <section id="about" className="bg-slate-100 py-20">
            <div className="mx-auto flex max-w-5xl flex-col gap-10 px-6 md:flex-row md:items-center">
              <div className="flex-1 space-y-5">
                ...
                <p className="text-lg text-slate-600">
                  With dedicated onboarding, real-time support, and integrations with the tools you already
                  use, we help businesses grow from bid to close-out.
                </p>
              </div>
